...
const DOM = {
    ...
    updateBalance(){
        ...
        let totalAcount = Transaction.total();
        let boxTotal = document.querySelector('.card.total');
        if(totalAcount<0){
            boxTotal.style.background = 'red';
        }
        else{
            boxTotal.style.background = '#49aa26';
        }
        document.getElementById('total-display').innerHTML = Utils.formatCurrency(totalAcount);
    },
    clearTransactions(){
